    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="flex items-center justify-center w-full h-full my-14  px-4">
                <CarouselProvider className="" naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={showsToDisplay.length <= 2 ? showsToDisplay.length : showsToDisplay.length - 2} visibleSlides={1} step={1} infinite={true}>
