    ...
    return (
        <div className="container mx-auto">
            ...
            <div className="flex items-center justify-center w-full h-full ">
                <CarouselProvider naturalSlideWidth={100} isIntrinsicHeight={true} totalSlides={showsToDisplay.length} visibleSlides={1} step={1} infinite={true}>
                    <div className="w-screen lg:w-full relative flex items-center justify-center">
                        ...
                        <div className="w-2/3 lg:w-full h-full mb-20 mx-auto overflow-x-hidden overflow-y-hidden">
                            <Slider>
