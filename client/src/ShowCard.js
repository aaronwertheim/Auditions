    ...
    return (
            <div class="flex flex-col md:flex-row overflow-hidden bg-white rounded-lg shadow-xl  mt-4 w-100  mx-2">
                ...
                <div class="w-full py-4 px-6 text-gray-800 flex flex-col justify-between">
                    ...
                    <p class="text-sm text-gray-700 uppercase tracking-wide font-semibold">{show.audition_date}<input class="bg-transparent ml-10" disabled={true} value={show.start_time} type="time"></input>-<input class="bg-transparent ml-10" disabled={true} value={show.end_time} type="time"></input></p>
                ...
                {user.role === "Performer" ? 
                    <Link   to={`/new-audition/${show.id}`} 
                            ...
                            className="px-2 py-1  h-fit rounded m-1 hover:bg-gray-300 text-gray-700 border shadow-md" >
                            Audition
                    </Link> : 
                    <>
